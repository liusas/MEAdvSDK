#
#  Be sure to run `pod spec lint MEAdvSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "刘峰" => "liufeng@mobiexchanger.com" }
  # Or just: spec.author    = "刘峰"
  # spec.authors            = { "刘峰" => "" }
  # spec.social_media_url   = "https://twitter.com/刘峰"
  ...
  spec.source       = { :git => "https://github.com/liusas/MEAdvSDK.git", :tag => spec.version }
...
#  spec.exclude_files = "Classes/Exclude"
  spec.vendored_framework = 'MEAdvSDK-1.0.31.1/ios/*.framework'
