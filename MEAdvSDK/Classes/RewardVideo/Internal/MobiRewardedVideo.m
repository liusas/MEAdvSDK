...
- (void)rewardedVideoAdViewRenderFailForAdManager:(MobiRewardedVideoAdManager *)manager error:(NSError *)error {
    id<MobiRewardedVideoDelegate> delegate = [self.delegateTable objectForKey:manager.posid];
    if ([delegate respondsToSelector:@selector(rewardedVideoAdViewRenderFail:error:)]) {
        [delegate rewardedVideoAdViewRenderFail:self error:error];
    }
}
...
- (void)rewardedVideoAdDidPlayFinishForAdManager:(MobiRewardedVideoAdManager *)manager didFailWithError:(NSError *)error {
    id<MobiRewardedVideoDelegate> delegate = [self.delegateTable objectForKey:manager.posid];
    if ([delegate respondsToSelector:@selector(rewardedVideoAdDidPlayFinish:didFailWithError:)]) {
        [delegate rewardedVideoAdDidPlayFinish:self didFailWithError:error];
    }
}
