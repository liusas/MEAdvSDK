...
+ (instancetype)adRequestedWithRequest:(MobiURLRequest *)request {
...
+ (instancetype)sdkInitializedWithNetworks:(NSArray<id<MobiAdapterConfiguration>> *)networks {
...
//    [networks enumerateObjectsUsingBlock:^(id<MobiAdapterConfiguration> _Nonnull adapter, NSUInteger idx, BOOL * _Nonnull stop) {
