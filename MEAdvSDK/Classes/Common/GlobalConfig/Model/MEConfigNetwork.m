...
NSString *const kMEConfigNetworkNtName = @"nt_name";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        self.ntName = [self objectOrNilForKey:kMEConfigNetworkNtName fromDictionary:dict];
    }
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.ntName forKey:kMEConfigNetworkNtName];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.ntName = [aDecoder decodeObjectForKey:kMEConfigNetworkNtName];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_ntName forKey:kMEConfigNetworkNtName];
}
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    if (copy) {
        ...
        copy.ntName = [self.ntName copyWithZone:zone];
    }
