...
NSString *const kMEConfigListOrderParameter = @"order_parameter";
...
@synthesize orderParameter = _orderParameter;
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        self.orderParameter = [self objectOrNilForKey:kMEConfigListOrderParameter fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    NSMutableArray *tempArrayForOrderParameter = [NSMutableArray array];
    for (NSObject *subArrayObject in self.orderParameter) {
        if([subArrayObject respondsToSelector:@selector(dictionaryRepresentation)]) {
            // This class is a model object
            [tempArrayForOrderParameter addObject:[subArrayObject performSelector:@selector(dictionaryRepresentation)]];
        } else {
            // Generic object
            [tempArrayForOrderParameter addObject:subArrayObject];
        }
    }
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForOrderParameter] forKey:kMEConfigListOrderParameter];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.orderParameter = [aDecoder decodeObjectForKey:kMEConfigListOrderParameter];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_orderParameter forKey:kMEConfigListOrderParameter];
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    if (copy) {
        ...
        copy.orderParameter = [self.orderParameter copyWithZone:zone];
