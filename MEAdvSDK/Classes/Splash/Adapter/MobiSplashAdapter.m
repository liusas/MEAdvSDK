...
- (void)splashAdDidClickSkipForCustomEvent:(MobiSplashCustomEvent *)splashAd {
    if (self.delegate && [self.delegate respondsToSelector:@selector(splashAdDidClickSkipForAdapter:)]) {
        [self.delegate splashAdDidClickSkipForAdapter:self];
    }
}
...
- (void)startTimeoutTimer {
    ...
    self.configuration.adTimeoutInterval : SPLASH_TIMEOUT_INTERVAL;
