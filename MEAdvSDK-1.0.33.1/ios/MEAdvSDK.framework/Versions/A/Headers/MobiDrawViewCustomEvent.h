...
@protocol MobiDrawViewCustomEventDelegate;
@class MobiConfig;

@protocol MobiDrawViewCustomEvent <NSObject>
...
@property (nonatomic, weak) id<MobiDrawViewCustomEventDelegate> delegate;

/// 当SDK请求拉取广告时,会调用此方法
/// 基类MobiDrawViewCustomEvent实现了MobiDrawViewCustomEvent接口
...
@interface MobiDrawViewCustomEvent : NSObject<MobiDrawViewCustomEvent>
...
@protocol MobiDrawViewCustomEventDelegate <NSObject>
/**
 * 拉取原生模板广告成功
 */
- (void)nativeExpressAdSuccessToLoadForCustomEvent:(MobiDrawViewCustomEvent *)customEvent views:(NSArray<__kindof UIView *> *)views;
 ...
 */
- (void)nativeExpressAdViewRenderSuccessForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生模板广告渲染失败
 */
- (void)nativeExpressAdViewRenderFailForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生模板广告曝光回调
 */
- (void)nativeExpressAdViewExposureForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生模板广告点击回调
 */
- (void)nativeExpressAdViewClickedForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生模板广告被关闭
 */
- (void)nativeExpressAdViewClosedForCustomEvent:(UIView *)nativeExpressAdView;
 ...
 * 点击原生模板广告以后即将弹出全屏广告页
 */
- (void)nativeExpressAdViewWillPresentScreenForCustomEvent:(UIView *)nativeExpressAdView;
 ...
 * 全屏广告页将要关闭
 */
- (void)nativeExpressAdViewDidDissmissScreenForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 详解:当点击应用下载或者广告调用系统程序打开时调用
 */
- (void)nativeExpressAdViewApplicationWillEnterBackgroundForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生模板视频广告 player 播放状态更新回调
 */
- (void)nativeExpressAdViewForCustomEvent:(UIView *)nativeExpressAdView playerStatusChanged:(MobiMediaPlayerStatus)status;

/**
 * 原生视频模板详情页 WillPresent 回调
 */
- (void)nativeExpressAdViewWillPresentVideoVCForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生视频模板详情页 DidPresent 回调
 */
- (void)nativeExpressAdViewDidPresentVideoVCForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生视频模板详情页 WillDismiss 回调
 */
- (void)nativeExpressAdViewWillDismissVideoVCForCustomEvent:(UIView *)nativeExpressAdView;

/**
 * 原生视频模板详情页 DidDismiss 回调
 */
- (void)nativeExpressAdViewDidDismissVideoVCForCustomEvent:(UIView *)nativeExpressAdView;

@optional
/// 调用这个代理方法,从上层获取userid用户唯一标识
/// @param customEvent 返回子类的`self`,便于上层处理计时等操作
- (NSString *)customerIdForDrawViewCustomEvent:(id<MobiDrawViewCustomEvent>)customEvent;
