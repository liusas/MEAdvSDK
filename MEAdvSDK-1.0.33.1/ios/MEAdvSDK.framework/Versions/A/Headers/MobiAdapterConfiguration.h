...
@protocol MobiAdapterConfiguration <NSObject>
@required
/**
...
/**
 MobiPub-specific name of the network.
 @remark This value should correspond to `creative_network_name` in the dashboard.
 */
@property (nonatomic, copy, readonly) NSString * mobiNetworkName;

/**
 Optional dictionary of additional values to send along with every MobiPub ad request
 on behalf of the adapter.
 */
@property (nonatomic, readonly, nullable) NSDictionary<NSString *, NSString *> * mobiPubRequestOptions;
...
#pragma mark - MobiPub Request Options

/**
 Adds entries into the managed @c mobiPubRequestOptions dictionary, overwriting any previously set
 entries.
 @param options Entries to add into @c mobiPubRequestOptions. This should not be @c nil.
 */
